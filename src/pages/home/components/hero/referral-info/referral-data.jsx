...
const ReferralData = () => {
  return (
    <>
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto shadow-md">
      <div className="lg:grid lg:grid-cols-12 lg:gap-16 lg:items-center lg:justify-between">
        <div className="lg:col-span-5 lg:col-start-1">
          <div className="mb-8">
            ...
            <p className="text-gray-600 ">
              Share the knowledge and get rewarded! Invite friends to join our
              courses and earn exclusive rewards.
            </p>
          </div>
          <blockquote className="relative">
            ...
            <div className="relative z-10">
              <p className="text-xl italic text-gray-800 ">
                Excellent platform for learning. Inviting friends made the
        ...
        <div className="mt-10 lg:mt-0 lg:col-span-6 lg:col-end-13">
          <div className="space-y-6 sm:space-y-8">
            <ul className="grid grid-cols-2 divide-y divide-y-2 divide-x divide-x-2 divide-blue-400 overflow-hidden ">
              <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-blue-500 mb-2 ">
                  10k+
                </div>
                <p className="text-sm sm:text-base text-blue-600 ">
                  students referred by their peers
                </p>
              </li>
              <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                ...
                <p className="text-sm sm:text-base text-gray-600 ">
                  increase in course enrollments through referrals
                </p>
              </li>
              <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-gray-800 mb-2 ">
                ...
                <p className="text-sm sm:text-base text-gray-600 ">
                  boost in student engagement with our courses
                </p>
              </li>
              <li className="flex flex-col -m-0.5 p-4 sm:p-8">
                <div className="flex items-end gap-x-2 text-3xl sm:text-5xl font-bold text-blue-500 mb-2 ">
                ...
                <p className="text-sm sm:text-base text-blue-600 ">
                  more rewards for our top referrers
                </p>
              </li>
            </ul>
          </div>
